...
algebra = stem.tracks.create(name: "Algebra", description: "Learn a lot of algebra!", image_url: "http://2.bp.blogspot.com/-QHLYgEEiG2w/U2dbxVvh0eI/AAAAAAAAACA/8TeJWNsjbho/s1600/Algebra+The+Band+logo.png")
thai = health.tracks.create(name: "Thai Food", description: "Make the most amazing pad thai...", image_url: "http://www.mintsdthai.com/resources/Pad%20Thai.jpg")
ukulele = music.tracks.create(name: "Ukulele", description: "Be that cool guy at that party.", image_url: "http://www.ukuleletricks.com/wp-content/uploads/2011/12/kala-ka-t-tenor-ukulele.jpg")
english = language.tracks.create(name: "English 101", description: "Where art thou?", image_url: "http://www.myenglishlanguage.com/wp-content/uploads/2012/01/english-language-guide.jpg")
ruby = stem.tracks.create(name: "Intro to Ruby", description: "Get your programming on!", image_url: "http://4jo.amazingwp.com/wp-content/uploads/sites/16/2013/07/red-jewel-250.png")
train = stem.tracks.create(name: "How Trains Work", description: "Because you always wondered..", image_url: "http://az616578.vo.msecnd.net/files/2016/02/27/6359219226453491021470707808_train.jpg")
g_and_s = music.tracks.create(name: "Appreciating Operrettas: Gilbert and Sullivan", description: "You'll soon be able to whistle all the airs from that infenral non-sense, Pinafore!", image_url: "https://upload.wikimedia.org/wikipedia/en/8/8c/Romanian_Opera_House_-_Timisoara.jpg")
