...
g_and_s = music.tracks.create(name: "Appreciating Operrettas: Gilbert and Sullivan", teacher_id: 2, description: "You'll soon be able to whistle all the airs from that infenral non-sense, Pinafore!", image_url: "https://upload.wikimedia.org/wikipedia/en/8/8c/Romanian_Opera_House_-_Timisoara.jpg")
